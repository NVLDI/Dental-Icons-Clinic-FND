...
const DeclineScreen = ({ navigation }) => {
  ...
  useEffect(() => {
    fetchDeclineData(setDeclineList, setError, setLoading);
  }, []);
  ...
  const filteredList = declineList.filter((item) =>
      ...
      <SafeAreaView style={styles.safeAreaTop}>
        ...
        <View style={styles.topBar}>
          ...
          {isSearchVisible ? (
            ...
            <Text style={{ color: '#fff', fontSize: 18, fontWeight: 'bold' }}>Declined</Text>
          )}
